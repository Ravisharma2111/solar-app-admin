...
import { PrivacyPolicyDetailSection } from "@/sections/dashboard/page_settings/privacy_policy";
...
const PrivacyPolicyDetail = () => {
  ...
  return (
    <ContainerComponent>
      ...
      />
      <PrivacyPolicyDetailSection data={data} />
    </ContainerComponent>
  );
};
PrivacyPolicyDetail.getLayout = (page) => (
