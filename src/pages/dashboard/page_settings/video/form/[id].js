...
import { VideoFormSection } from "@/sections/dashboard/page_settings/video";
...
const VideoForm = () => {
  ...
  const backUrl = `${PATH_DASHBOARD.page_settings.video}`;
  const EditactionUrl = "video/getData";
  const UpdateActionUrl = "video/updateVideoData";
  const addActionUrl = "video/addVideo";
  ...
  return (
    <ContainerComponent>
      ...
      <form noValidate onSubmit={formik.handleSubmit}>
        <VideoFormSection formik={formik} />
